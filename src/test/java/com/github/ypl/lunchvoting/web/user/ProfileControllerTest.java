...
import static com.github.ypl.lunchvoting.web.user.ProfileController.REST_URL;
...
import static com.github.ypl.lunchvoting.web.user.UserTestData.USER_MATCHER;
import static com.github.ypl.lunchvoting.web.user.UserTestData.admin;
import static com.github.ypl.lunchvoting.web.user.UserTestData.getNew;
import static com.github.ypl.lunchvoting.web.user.UserTestData.getUpdated;
import static com.github.ypl.lunchvoting.web.user.UserTestData.jsonWithPassword;
import static com.github.ypl.lunchvoting.web.user.UserTestData.user;
...
public class ProfileControllerTest extends AbstractControllerTest {
    ...
    void registerInvalid() throws Exception {
        User invalid = new User(null, null, null, "pass");
    ...
    void updateInvalid() throws Exception {
        User invalid = new User(null, null, null, "password");
        perform(MockMvcRequestBuilders.put(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(invalid))
                .content(jsonWithPassword(invalid, invalid.getPassword())))
